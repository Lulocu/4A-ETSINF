...
set label "K" at 650,2.0 right
set label "Error (%)" at 0.92,85 left
#set label "Original" at 5.92,83.9 left
#set label "Alpha 1e-05" at 100,20 center font "HelveticaBold,30"
...
plot "resD1" u 1:2 title "D = 1" w lp lw 2 lt rgb "#37FF00" ps 1.0,"resD2" u 1:2 title "D = 2" w lp lw 2 lt rgb "#F3FF00" ps 1.0,"resD5" u 1:2 title "D = 5" w lp lw 2 lt rgb "#FF0000" ps 1.0,"resD10" u 1:2 title "D = 10" w lp lw 2 lt rgb "#00FFF7" ps 1.0,"resD20" u 1:2 title "D = 20" w lp lw 2 lt rgb "#0400FF" ps 1.0,"resD30" u 1:2 title "D = 30" w lp lw 2 lt rgb "#FF00E4" ps 1.0
